...
const schema = z.object({
  ...
  CHAIN_PROVIDER: z.enum(["mock", "ton_mainnet", "ton_testnet"]).default("mock"),
  ...
  TON_TESTNET_CONTRACT_ADDRESS: z.string().optional(),
  TON_DEPOSIT_VAULT_ADDRESS: z.string().optional(),
